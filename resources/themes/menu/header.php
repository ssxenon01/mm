                ...
                <div class="col-md-12">
                    ...
                    <!--<div class="pull-right">
                        <ul class="socialLinks">
                            <li>
                                <a href="#"><img src="img/facebook.png" width="18" height="18"></a>
                            </li>
                            <li>
                                <a href="#"><img src="img/twitter.png" width="18" height="18"></a>
                            </li>
                            <li>
                                <a href="#"><img src="img/youtube.png" width="18" height="18"></a>
                            </li>
                            <li>
                                <a href="#"><img src="img/rss.png" width="18" height="18"></a>
                            </li>
                        </ul>
                    </div>-->
                </div>
    ...
    <div class="m-container">
        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container force-reset">
                <div class="row">
                    <div class="col-md-12">
                        <div class="navbar-brand hidden-xxs">
                            <a href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home">
                                <?php if (Bunyad::options()->image_logo): // custom logo ?>

                                    <img src="<?php echo esc_attr(Bunyad::options()->image_logo); ?>" class="hidden-sm" alt="<?php
