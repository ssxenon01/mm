...
<?php   if (!empty($entity->directory_contact[0]['mobile'])):?>
                    <span class="sabai-directory-mobile" itemprop="telephone"><span class="sabai-directory-separator"> / </span><?php printf(__('%s (Mobile)', 'sabai-directory'), Sabai::_h($entity->directory_contact[0]['mobile']));?></span>
<?php   endif;?>
