...
<?php   if ( ($fieldName != 'field-with-whom' && $fieldName != 'field-what' && $fieldName != 'field-location' && $fieldName != 'field-tenant-feature') && $field_output = $this->Entity_RenderField($entity, $field['type'], $field['settings'], $field['values'])):?>
