...
<p><?php echo $this->Content_RenderSummary($entity, 150);?></p>
...
<?php foreach ($custom_fields as $field):?>
    <dt><?php echo $field['title'];?> (<?php echo $field['name'];?>)</dt>
    <dd><?php echo $this->Entity_RenderField($entity, $field['type'], $field['settings'], $field['values']);?></dd>
