...
(function($){
    ...
    SABAI.GoogleMaps.geocoder = SABAI.GoogleMaps.geocoder || new google.maps.Geocoder();
    SABAI.GoogleMaps.markerMap = SABAI.GoogleMaps.markerMap || function (mapId, clat, clng, lat, lng, zoom, icon, styles, options) {
