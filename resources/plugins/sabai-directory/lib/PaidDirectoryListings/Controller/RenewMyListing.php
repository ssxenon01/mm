<?php
class Sabai_Addon_PaidDirectoryListings_Controller_RenewMyListing extends Sabai_Addon_Form_MultiStepController
{    
    ...
    protected function _getFormForStepOrder(Sabai_Context $context, array &$formStorage)
    {
        ...
        try {
            return $this->PaidListings_OrderForm($context->entity, 'directory_listing_renewal', $context->getRoute(), $this->getAddon()->getConfig('paypal'), __('Submit', 'sabai-directory'));
    ...
    protected function _getFormForStepConfirmOrder(Sabai_Context $context, array &$formStorage)
    {
        ...
        return $this->PaidListings_ConfirmOrderForm(
            $context->entity,
            $formStorage['values']['order']['plan'], // plan ID
