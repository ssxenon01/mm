...
class RoyalSliderAdmin {
	...
	*/
	...
	function admin_init() {			
		...
		wp_register_script( 'royalslider-js', $this->url .'js/royal-slider-7.9.min.js' );
	}
	/**
	...
	function frontend_styles_and_scripts() {		
		if(!is_admin()) {
			...
			if(count($this->styles_to_load) > 0) {
				...
				wp_register_script( 'royalslider-js', $this->url .'js/royal-slider-7.9.min.js',array("jquery"),"1.0",false);
				wp_enqueue_script( 'royalslider-js' );
