...
{
    /**
     * Default route to which requeste will be routed
     *
     * @var SabaiFramework_Application_Route
     */
     ...
     * Constructor
     *
     * @param SabaiFramework_Application_Route $defaultRoute
     * @param bool $autoloadControllers
     * @return SabaiFramework_Application_RoutingController
     */
    protected function __construct(SabaiFramework_Application_Route $defaultRoute, $autoloadControllers = false)
    {
    ...
    public function execute(SabaiFramework_Application_Context $context)
    {
        if (isset($this->_route)
            ...
            $this->_doExecute($context, $this->_defaultRoute);
        }
    }
