...
class SabaiFramework_HTMLQuickForm extends HTML_QuickForm
{
    ...
    public function init()
    {
        ...
        if (!self::$_initialized) {
            ...
            self::registerElementType('footer', 'SabaiFramework_HTMLQuickForm_Element_Footer');
    ...
    public function registerElementType($type, $class, $file = null)
    {
     ...
     */
    public function createElement($type, array $args)
    {
    ...
    {
        $this->addElement('footer', null, $footer);
    }
}
