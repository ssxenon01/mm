...
class Sabai_Addon_Content_Controller_Feed extends Sabai_Controller
{
    ...
    protected function _getItemTitle(Sabai_Context $context, Sabai_Addon_Content_Entity $post)
    {
        return $post->getTitle();
    }
        
    protected function _getItemContent(Sabai_Context $context, Sabai_Addon_Content_Entity $post)
    {
        return $post->getSingleFieldValue('content_body', 'filtered_value');
    }
        
    protected function _getItemExtras(Sabai_Context $context, Sabai_Addon_Content_Entity $post)
    {
        return array();
    }
