...
abstract class Sabai_Addon_Content_Model_Base_PostGateway extends SabaiFramework_Model_Gateway
{
    ...
    protected function _getInsertQuery(&$values)
    {
        ...
        return sprintf('INSERT INTO %scontent_post(post_title, post_slug, post_published, post_status, post_views, post_entity_bundle_name, post_entity_bundle_type, post_created, post_updated, post_user_id) VALUES(%s, %s, %d, %s, %d, %s, %s, %d, %d, %d)', $this->_db->getResourcePrefix(), $this->_db->escapeString($values['post_title']), $this->_db->escapeString($values['post_slug']), $values['post_published'], $this->_db->escapeString($values['post_status']), $values['post_views'], $this->_db->escapeString($values['post_entity_bundle_name']), $this->_db->escapeString($values['post_entity_bundle_type']), $values['post_created'], $values['post_updated'], $values['post_user_id']);
    }
