...
abstract class Sabai_Addon_File_Model_Base_FileGateway extends SabaiFramework_Model_Gateway
{
    ...
    protected function _getInsertQuery(&$values)
    {
        ...
        return sprintf('INSERT INTO %sfile_file(file_name, file_title, file_type, file_size, file_extension, file_hash, file_is_image, file_width, file_height, file_created, file_updated, file_token_id, file_user_id) VALUES(%s, %s, %s, %d, %s, %s, %d, %d, %d, %d, %d, %d, %d)', $this->_db->getResourcePrefix(), $this->_db->escapeString($values['file_name']), $this->_db->escapeString($values['file_title']), $this->_db->escapeString($values['file_type']), $values['file_size'], $this->_db->escapeString($values['file_extension']), $this->_db->escapeString($values['file_hash']), $values['file_is_image'], $values['file_width'], $values['file_height'], $values['file_created'], $values['file_updated'], $values['file_token_id'], $values['file_user_id']);
    }
