...
class Sabai_Addon_System_Controller_Admin_UninstallAddon extends Sabai_Addon_Form_Controller
{
    ...
    protected function _doGetFormSettings(Sabai_Context $context, array &$formStorage)
    {
        ...
        return array(
            ...
            '#header' => array('<div class="sabai-error">' . $message . '</div>'),
    ...
    {
        $log = new ArrayObject();
        $this->doEvent('SabaiAddonUninstall', array($this->_addon, $log));
        $this->UninstallAddon($this->_addon, $log);
        $this->reloadAddons(false)->doEvent('SabaiAddonUninstalled', array($this->_addon, $log));
