...
class Sabai_Addon_FieldUI_Controller_Admin_EditFieldWidget extends Sabai_Addon_Form_Controller
{
    ...
    protected function _doGetFormSettings(Sabai_Context $context, array &$formStorage)
    {
        ...
        $this->_cancelUrl = $this->Url($bundle->getPath() . '/fields/edit', array('ele_id' => $context->getRequest()->asStr('ele_id'), 'field_id' => $this->_field->id));
        ...
        }', $this->Url($bundle->getPath() . '/fields/edit', array('ele_id' => $context->getRequest()->asStr('ele_id'), 'field_id' => $this->_field->id), '', '&'));
    ...
    public function submitForm(Sabai_Addon_Form_Form $form, Sabai_Context $context)
    {
        ...
        $context->setSuccessAttributes(array(
            ...
            'preview' => $this->FieldUI_PreviewWidget($this->_field),
        ));
    }
}