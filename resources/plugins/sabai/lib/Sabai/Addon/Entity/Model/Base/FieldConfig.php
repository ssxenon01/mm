...
abstract class Sabai_Addon_Entity_Model_Base_FieldConfig extends SabaiFramework_Model_Entity
{
    public function __construct(SabaiFramework_Model $model)
    {
        ...
        $this->_vars = array('fieldconfig_name' => null, 'fieldconfig_type' => null, 'fieldconfig_storage' => null, 'fieldconfig_system' => 0, 'fieldconfig_settings' => null, 'fieldconfig_property' => null, 'fieldconfig_schema' => null, 'fieldconfig_id' => 0, 'fieldconfig_created' => 0, 'fieldconfig_updated' => 0, 'fieldconfig_entitytype_name' => null, 'fieldconfig_bundle_id' => 0);
    }
    ...
    public function __set($name, $value)
    {
        ...
        elseif ($name === 'entitytype_name')
            $this->_assignEntityById('EntityType', $value, 'fieldconfig_entitytype_name');
        elseif ($name === 'EntityType') {
            $_value = is_array($value) ? $value[0] : $value;
            if (is_object($_value)) {
                $this->_assignEntity($_value, 'fieldconfig_entitytype_name');
            } else {
                $this->_assignEntityById('EntityType', $_value, 'fieldconfig_entitytype_name');
            }
        }
        elseif ($name === 'bundle_id')
...
abstract class Sabai_Addon_Entity_Model_Base_FieldConfigRepository extends SabaiFramework_Model_EntityRepository
{
    ...
    {
        return $this->_fetchByForeign('fieldconfig_entitytype_name', $id, $limit, $offset, $sort, $order);
    }
    ...
    {
        return $this->_countByForeign('fieldconfig_entitytype_name', $id);
    }

    public function fetchByEntityTypeAndCriteria($id, SabaiFramework_Criteria $criteria, $limit = 0, $offset = 0, $sort = null, $order = null)
    {
        return $this->_fetchByForeignAndCriteria('fieldconfig_entitytype_name', $id, $criteria, $limit, $offset, $sort, $order);
    }
    ...
    {
        return $this->_countByForeignAndCriteria('fieldconfig_entitytype_name', $id, $criteria);
    }
