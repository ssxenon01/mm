...
abstract class Sabai_Addon_Entity_Model_Base_FieldGateway extends SabaiFramework_Model_Gateway
{
    ...
    protected function _getInsertQuery(&$values)
    {
        ...
        return sprintf('INSERT INTO %sentity_field(field_data, field_created, field_updated, field_bundle_id, field_fieldconfig_id) VALUES(%s, %d, %d, %d, %d)', $this->_db->getResourcePrefix(), $this->_db->escapeString(serialize($values['field_data'])), $values['field_created'], $values['field_updated'], $values['field_bundle_id'], $values['field_fieldconfig_id']);
    }
