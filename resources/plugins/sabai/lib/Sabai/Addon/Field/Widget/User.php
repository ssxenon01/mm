            ...
            case 'user_select':
                return array(
                    'current_user_selected' => array(
                        ...
                        '#description' => __('Check this option to set the current user selected by default if the field has not been selected yet.', 'sabai'),
                        '#default_value' => $settings['current_user_selected'],
                    ),
                    'enhanced_ui' => array(
                        '#type' => 'checkbox',
                        '#title' => __('Enable enhanced user interface (recommended)', 'sabai'),
                        '#description' => sprintf(__('Check this to apply the jQuery %s plugin to this field to enable ajax auto-suggestion and more user friendly input method.'), '<a href="http://ivaynberg.github.com/select2/" target="_blank">Select2</a>', 'sabai'),
