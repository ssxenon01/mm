...
class Sabai_Route implements SabaiFramework_Application_Route
{
    ...
    /**
     * Gets the name of event associated with the requested controller
     *
     * @return string
     */
    public function getControllerEventName()
    {
        return isset($this->_data['controller_event']) ? $this->_data['controller_event'] : null;
    }
        
    /**
     * Sets the name of event associated with the requested controller
     *
     * @param string $eventName
     */
    public function setControllerEventName($eventName)
    {
        $this->_data['controller_event'] = $eventName;
    }
