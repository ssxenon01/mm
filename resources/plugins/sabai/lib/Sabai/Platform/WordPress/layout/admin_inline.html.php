...
<?php       echo $this->LinkToRemote($_PAGE_MENU['title'], $_PAGE_MENU['ajax'] == 2 ? '#sabai-modal' : '#sabai-content', $_PAGE_MENU['url'], $_PAGE_MENU['options'], $attr);?>
<?php     else:?>
<?php       echo $this->LinkTo($_PAGE_MENU['title'], $_PAGE_MENU['url'], $_PAGE_MENU['options'], $attr);?>
<?php     endif;?>
<?php   endforeach;?>
<?php endif;?>
</h2>
