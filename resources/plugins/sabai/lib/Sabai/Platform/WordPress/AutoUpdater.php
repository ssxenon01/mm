...
class Sabai_Platform_WordPress_AutoUpdater
{
    ...
    {        
        ...
        if (version_compare(Sabai_Platform_WordPress::getCurrentPluginVersion($this->_pluginName), $remote_info->version, '<')) {
            $obj = new stdClass();  
    ...
    public function getRemoteInfo()
    {
        if (!isset($this->_remoteInfo)) {
            ...
            $request_body = array(
                ...
                'site_url' => home_url(),
                'package_version' => Sabai_Platform_WordPress::getCurrentPluginVersion($this->_pluginName),
                'sabai_version' => Sabai_Platform_WordPress::getCurrentPluginVersion('sabai'),
            ) + $this->_remoteArgs;
