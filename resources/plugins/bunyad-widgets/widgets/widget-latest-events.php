...
class Bunyad_LatestEvents_Widget extends WP_Widget
{
	public function __construct()
	{
		parent::__construct(
			'bunyad-latest-events-widget',
			'Bunyad - Recent events',
			array('description' => 'Recent events with thumbnail.', 'classname' => 'latest-events')
		);
	...
	public function widget($args, $instance) 
	{
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Recent events', 'bunyad-widgets') : $instance['title'], $instance, $this->id_base);
                ...
                <?php  while ($r->have_posts()) : $r->the_post(); global $post; ?>
                    <div class="news-list clearfix">
                        <div class="img-container">
                            <?php the_post_thumbnail('recent-events', array('title' => strip_tags(get_the_title()))); ?>
                        </div>
                        <div class="news-body">
...
?>
		...
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of events to show:', 'bunyad-widgets'); ?></label>
