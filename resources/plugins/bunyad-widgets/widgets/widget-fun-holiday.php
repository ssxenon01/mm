...
class Bunyad_FunHoliday_Widget extends WP_Widget
{
	public function __construct()
	{
		parent::__construct(
			'bunyad-fun-holiday-widget',
			'Bunyad - Fun Holiday',
			array('description' => 'Recent posts with thumbnail.', 'classname' => 'fun-holiday')
		);
	...
	{
		$cache = get_transient('bunyad_widget_fun_holiday');
                    ...
                    <?php  while ($r->have_posts()) : $r->the_post(); global $post; ?>
                        ...
                        <div class="col-md-4">
                            <div class="trans-box">
                                ...
                                <h1><?php if (get_the_title()) the_title(); else the_ID(); ?></h1>
...
<?php
		...
		set_transient('bunyad_widget_fun_holiday', $cache);
	}
	...
	{
		delete_transient('bunyad_widget_fun_holiday');
	}
